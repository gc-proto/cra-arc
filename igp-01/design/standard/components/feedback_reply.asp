...
<html class="no-js" lang="en" dir="ltr">
   <head>
      ...
      <title>Thank you for your comments – Standard web pages – CRA instructional guidance product – Canada.ca</title>
   ...
   <body vocab="http://schema.org/" typeof="WebPage" class="cnt-wdth-lmtd">
      ...
      <script type="text/javascript">
         ...
         defTop.outerHTML = wet.builder.top({
           ...
           breadcrumbs: [{
             title: "CRA instructional guidance product",
...
<!-- CONTENT STARTS -->
                   <h1 property="name" class="wb-inv" id="wb-cont" dir="ltr">Thank you for your comments – Standard web pages – CRA instructional guidance product</h1>
<div aria-hidden="true">
<p class="lead mrgn-tp-md mrgn-bttm-0 text-muted">CRA instructional guidance product</p>
<h1 class="gc-thickline mrgn-tp-0">Thank you for your comments – Standard web pages</h1>
</div>
