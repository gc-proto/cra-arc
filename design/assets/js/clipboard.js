 ...
 ( function( $, window, wb ) {
    ...
    var componentName = "wb-clipboard",
        ...
        checkTextInputElm = function ( elm ) {
            ...
            if ( elm.tagName === "TEXTAREA" || (elm.tagName === "INPUT" && elm.type.includes(validInputType) === true )) {
                return true;
            }
            return false;
        }, 
        ...
        updateElmCopy = function( copyAreaElm ) { // , checkElm
//            if ( copyAreaElm === checkElm || $( copyAreaElm ).hasClass( "wb-clipboard" ) === true ) {
